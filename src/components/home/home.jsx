...
function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col-reverse items-center justify-around p-20 sm:flex-row">
        ...
        <div className="w-full sm:w-1/2">
          <img
            className="font-shit bg mb-[30px] w-full object-cover sm:mb-0"
      ...
      <div className="primary-bg flex flex-col-reverse items-center justify-around p-20 text-white sm:flex-row">
        <div className="w-full sm:w-1/2">
        ...
        <div className="w-full sm:w-1/2">
          <img
            className="mb-[30px] w-full object-cover sm:mb-0"
      ...
      <button
        className="primary-bg m-[50px] h-[50px] w-[200px] self-center rounded-[8px] border border-green-900 p-2.5 text-2xl text-white shadow-black/50 transition-transform hover:scale-110 hover:shadow-md"
        onClick={() => {
          navigate("/shop");
        }}
      >
